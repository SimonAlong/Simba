import {
  ...
  update,
  pageCount
} from '@/services/${appName}/${tablePathNameLower}Api';

export default {
  namespace: '${tablePathNameLower}Model', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({payload}, { put }) {
      // console.log('${tablePathNameLower}Model.tableFresh 参数：');
    ...
    *add({ payload }, { call, put }) {
      // console.log('${tablePathNameLower}Model.add 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *delete({ payload }, { call, put }) {
      // console.log('${tablePathNameLower}Model.delete 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *update({ payload }, { call, put }) {
      // console.log('${tablePathNameLower}Model.update 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *pageList({ payload }, { call, put }) {
      // console.log('${tablePathNameLower}Model.pageList 参数：');
      // console.log(JSON.stringify(payload));
      ...
      // console.log('${tablePathNameLower}Model.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('${tablePathNameLower}Model.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      // console.log('${tablePathNameLower}Model.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      // console.log('${tablePathNameLower}Model.handlePageListResult 返回的结果');
    ...
    handleUpdateResult(state, action) {
      // console.log('${tablePathNameLower}Model.handleUpdateResult 返回的结果');
      // console.log(JSON.stringify(action.payload));
    ...
    handleDeleteResult(state, action) {
      // console.log('${tablePathNameLower}Model.handleDeleteResult 返回的结果');
