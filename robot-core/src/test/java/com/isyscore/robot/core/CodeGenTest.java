...
public class CodeGenTest {
    ...
    public void generate1() {
        ...
        // 设置表前缀过滤
        codeGen.setPreFix("jcun_");
        // 设置要输出的表
        codeGen.setTableName("jcun_people_trace");

        // 设置："新增弹窗"中展示的属性，对应后端的InsertReq
        codeGen.setInsertFields("people_id");

        // 设置："修改弹窗"中展示的属性，对应后端的UpdateReq
        codeGen.setUpdateFields("id", "people_id");

        // 设置："搜索框"中展示的属性，对应后端的Pager中的QueryReq
        codeGen.setQueryFields("name", "concern_id");

        /*=============================================================================== 前端代码配置 =======================*/
        // 设置前端代码路径
        codeGen.setFrontCodePath("/Users/zhouzhenyong/project/isyscore/other-jc-front");

        /*========= 要展示的表基本信息（必填） ========*/
        // 设置表的中文名，如果没有设置，则采用DB中的描述
        codeGen.setTableDesc("重点人群的通行记录");

        /*=========== 表的属性信息（非必填） =======*/
        // 设置表的字段和中文文案对应，不填则采用注释，如果注释没有则采用列名
        codeGen.setFieldNameMap(NeoMap.of()
            .append("id", "序号")
            .append("concern_name", "分类名称")
        );
        ...
        codeGen.setUnEditFields("id");

        /*============= 界面表格展示信息 ===========*/
        // 设置："表格"中展示的属性（必填）
        codeGen.setTableShowFieldsMap("id", "people_id", "name", "concern_id", "show_time", "trace_status");
...
//        codeGen.setTableExpandFieldsMap("id", "update_time", "center", "status");
        ...
        codeGen.setBackendModulePath("/Users/zhouzhenyong/project/isyscore/other-jc");

        // 设置："package包"
        codeGen.setBackendPackage("com.isyscore.other");
